...
* 🔥 **FAIL** Current Font Bakery version is 0.8.13, while a newer 0.10.4 is already available. Please upgrade it with 'pip install -U fontbakery' [code: outdated-fontbakery]
